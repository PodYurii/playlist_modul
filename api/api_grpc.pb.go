...
func (c *playlistClient) SignIn(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*OnlyToken, error) {
	out := new(OnlyToken)
...
func (c *playlistClient) SignUp(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (UnimplementedPlaylistServer) SignIn(context.Context, *AuthRequest) (*OnlyToken, error) {
